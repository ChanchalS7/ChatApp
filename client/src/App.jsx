...
const App = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // } else {
    //   alert("messsage cannot be empty");

    // }
    !newMessage == "" ? socket.emit('send-message', messageData) : alert("messsage cannot be empty");
    setNewMessage("")
  }
  return (
    <>
      <div className="w-screen h-screen bg-gray-100 flex justify-center items-center">
        {
          chatActive ?
            (<div className="rounded-md w-full md:w-[80vw] lg:w-[40vw]">
              <h1 className="text-center font-bold text-xl my-2 uppercase">Squad-Room</h1>
              <div className="">
                <div className="overflow-y cr422ww3-scroll h-[80vh] lg:h-[60vh]">
                  {
